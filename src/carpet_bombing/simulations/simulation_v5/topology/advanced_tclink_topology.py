...
SIMULATED_SOURCE_IPS = "192.0.2.10,192.0.2.11,198.51.100.20,198.51.100.21,203.0.113.30,203.0.113.31"
ACTIVE_VICTIM_IPS = [
    "10.0.0.1",
    "10.0.0.2",
    "10.0.0.3",
...
def run(auto_scenario=None, duration=45, attack_duration=30, warmup=5):
    ...
    print("\nSimulation V5 : topologie multi-routeurs + trafic avancé")
